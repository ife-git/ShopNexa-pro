...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        login(data.user);
        showNotification(`Welcome to ShopNexa, ${data.user.name}!`, "success");
        navigate("/");
      } else {
  ...
  return (
    <div className="signup-container">
      <header className="auth-header">
        ...
        <p className="auth-header-sub">Your one-stop shop for everything</p>
      </header>
      ...
      <main className="sign-forms">
        <form onSubmit={handleSubmit} autoComplete="off">
          <div className="form-inner">
            ...
            <p>Join ShopNexa to start shopping</p>
